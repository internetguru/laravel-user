    ...
    <div class="row row-basic row-stretched">
        <div class="card card-register">
            ...
            <x-ig::form action="register-email" :route="route('register.email.handle')" class="editable-skip">
                <x-ig::input type="text" name="name" autocomplete="name" required>@lang('ig-user::auth.register-email.name')</x-ig::input>
                <x-ig::input type="email" name="email" autocomplete="email" required>@lang('ig-user::auth.register-email.email')</x-ig::input>
