    ...
    <div class="row row-basic row-stretched">
        ...
        @else
            <div class="card">
                ...
                <p class="mt-3 mb-0 text-end"><a href="{{ route('token_auth') }}">@lang('auth::auth.token_auth.title')</a></p>
                <p class="mt-1 mb-0 text-end"><a href="{{ route('register') }}">@lang('auth::auth.register.title')</a></p>
            </div>
        @endif
    </div>
</section>
