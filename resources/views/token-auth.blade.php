<section class="section section-token-auth">
    <div class="row row-basic row-stretched">
        <div class="card card-token-auth">
            ...
            <x-ig::form :action="route('token-auth.form')" class="editable-skip">
                <x-ig::input type="email" name="email" autocomplete="email" required>@lang('ig-user::auth.token_auth.email')</x-ig::input>
