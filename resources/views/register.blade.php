<div class="section section-register">
    <div class="row row-basic row-stretched">
        <div class="card card-register">
            ...
            <p class="mt-3 mb-1 text-end"><a href="{{ route('register.email') }}">@lang('ig-user::layouts.register-email.title')</a></p>
            <p class="mb-0 text-end"><a href="{{ route('login') }}">@lang('ig-user::auth.back')</a></p>
        </div>
    </div>
</div>
