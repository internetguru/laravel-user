...
_Stable release based on [9.0.0-rc.1]._

## [9.0.0-rc.1] - 2026-09-25
...
- The test suite installs from the lock file again and expects account keys as strings.

### Changed

- CI runs only on the main branch.
...
- Give the empty identity notice the same spacing as the list.
...
## [7.14.0-rc.1] - 2026-09-07

## [7.13.3] - 2026-09-07

### Fixed

- Fix user roles page description translation.
...
- List a short set of merge candidates without a search box.
...
## [7.8.0-rc.1] - 2026-08-27

## [7.7.3] - 2026-08-23

### Changed

- Update laravel-model-browser to v6.
...
- Fix standalone and login system-notice messages.

## [7.5.1] - 2026-08-06

### Fixed

- Fix system-notice translations.
...
- Always remember demo login.

## [7.2.0] - 2026-06-15

_Stable release based on [7.2.0-rc.1]._

## [7.2.0-rc.1] - 2026-06-15
...
- Fix composer model-browser version.

## [7.0.0] - 2026-06-03

_Stable release based on [7.0.0-rc.1]._

## [7.0.0-rc.1] - 2026-06-03
...
- Align user edit history and show it only for managers+.

## [6.6.0] - 2026-04-07

_Stable release based on [6.6.0-rc.1]._

## [6.6.0-rc.1] - 2026-04-07

### Added

- Add dynamic `is{Role}()` and `is{Role}Plus()` methods on User model.
...
- Fix switching between lang domains.
...
- Log invalid pin login attempt.

## [6.2.4] - 2026-03-15

### Fixed

- Fix success login message and redirect.
...
## [6.2.0-rc.1] - 2026-03-14

### Added

- Add unified login/register page combining socialite, PIN login, and registration into a single view.
- Add "Remember me" checkbox on login page, persisted through PIN login flow.
- Add "Create a new account if not found" checkbox for inline registration via PIN login.
- Add `remember` and `register` columns to `pin_logins` table.
- Add feature tests for PIN login controller.

### Changed

- Redirect `/register` and `/pin-login` routes to unified `/login` page.
- Remove separate register, register-email, and pin-login views and controllers.
- Remove `/send/{user}` PIN login route in favor of form-based sending only.
...
- Rename all token-auth routes, views, controllers, and translations to pin-login.
- Set PIN expiry to 2 days.

### Removed

- Remove token-based authentication (URL callback with signed token).

## [6.0.1] - 2026-03-04

### Changed

- Treat invalid provider / action as 404 instead of logging error.
...
- Review inputs autocomplete attributes.

## [5.2.0] - 2026-02-14

_Stable release based on [5.2.0-rc.1]._

## [5.2.0-rc.1] - 2026-02-14
...
- Auto-apply laravel-model-browser filters.
...
## [5.1.0-rc.1] - 2026-02-04

# Added

- Add user preferences table with simple set and get methods.
...
- Fix workflow concurrency between repos.
...
- Update IG user seeder emails to @internetguru.io.

## [4.2.4] - 2026-01-05

### Fixed

- Fix getByEmail is optional.

## [4.2.3] - 2026-01-05

### Fixed

- Fix use detail visual and socialite connect email.
...
- Make socialite email optional instead of removing it completely.

## [4.2.0] - 2026-01-05

_Stable release based on [4.2.0-rc.1]._

## [4.2.0-rc.1] - 2026-01-05
...
- Fix test import for recaptcha, fix local tests php version.
...
- Fix registration email language.
...
- Add User::publicRolesArray function.

## [4.1.2] - 2025-12-04

### Fixed

- Use providers dynamically using providers() function.

## [4.1.1] - 2025-12-04

### Fixed

- Adjust user list column widths.

## [4.1.0] - 2025-12-04

_Stable release based on [4.1.0-rc.1]._

## [4.1.0-rc.1] - 2025-12-04
...
[8.1.0-rc.1]: https://github.com/internetguru/laravel-user/releases/tag/v8.0.0
...
[7.13.2]: https://https://github.com/internetguru/laravel-user/compare/v7.13.1...v7.13.2
...
[7.12.0-rc.1]: https://github.com/internetguru/laravel-user/releases/tag/v7.11.2
...
[7.8.0-rc.1]: https://github.com/internetguru/laravel-user/releases/tag/v7.7.3
[7.7.3]: https://https://github.com/internetguru/laravel-user/compare/v7.7.2...v7.7.3
...
[7.5.1]: https://https://github.com/internetguru/laravel-user/compare/v7.5.0...v7.5.1
...
[7.1.0]: https://https://github.com/internetguru/laravel-user/compare/v7.0.2...v7.1.0
[7.1.0-rc.1]: https://github.com/internetguru/laravel-user/releases/tag/v7.0.2
...
[6.5.0]: https://https://github.com/internetguru/laravel-user/compare/v6.4.7...v6.5.0
[6.5.0-rc.1]: https://github.com/internetguru/laravel-user/releases/tag/v6.4.7
[6.4.7]: https://https://github.com/internetguru/laravel-user/compare/v6.4.6...v6.4.7
...
[6.1.3]: https://https://github.com/internetguru/laravel-user/compare/v6.1.2...v6.1.3
...
[5.1.2]: https://https://github.com/internetguru/laravel-user/compare/v5.1.1...v5.1.2
...
[4.2.3]: https://https://github.com/internetguru/laravel-user/compare/v4.2.2...v4.2.3
...
[4.1.0]: https://https://github.com/internetguru/laravel-user/compare/v4.0.0...v4.1.0
[4.1.0-rc.1]: https://github.com/internetguru/laravel-user/releases/tag/v4.0.0
